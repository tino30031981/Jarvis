                        ...
                        var BaseWidget = (function (_super) {
                                    ...
                                    if ($divList.is(':empty')) {
                                        ...
                                        for (i = 0; i < baseMaps.length; i++) {
                                            ...
                                            for (var j = 0; j < baseMaps[i].items.length; j++) {
                                                ...
                                                var $a = $('<a></a>');
                                                $a.append($rdb);
                                                $a.append('&nbsp;<label for="' + baseMaps[i].items[j].id + '">' + baseMaps[i].items[j].label + '</label>');
                                                var $li = $('<li></li>');
                                                $li.append($a);
                            ...
                            BaseWidget.prototype.buildTool = function () {
                                ...
                                var options = {
                                    ...
                                    location: "left",
                                    clssButton: "jca-btn-left",
                                    callback: null
                                };
                                var uuid = thiss.getUUID();
                                var $div = $('<div class="' + options.clssButton + '"></div>').appendTo(thiss.$toolbar.find("#" + options.location));
                                var $button = null;
                                ...
                                $button.addClass('jca-btn-circle');
