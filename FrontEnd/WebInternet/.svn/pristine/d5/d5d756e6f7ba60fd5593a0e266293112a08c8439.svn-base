function getObject() {
    return com.jtm.geometry.viewer.widgets.indicator.thematicmap.Widget.execute();
}
(function (com) {
    (function (jtm) {
        (function (geometry) {
                            ...
                            var Widget = (function (_super) {
                                ...
                                function Widget() {
                                    ...
                                    this.execute = function () {
                                        ...
                                        if (jQuery('#' + thiss.domWidget + ' #ddlClassificationType').val().toUpperCase() == Widget.UNIQUEVALUEDEF.toUpperCase())
                                ...
                                Widget.UNIQUEVALUEDEF = 'uniqueValueDef';
                                Widget.CLASSBREAKSDEF = 'classBreaksDef';
                                ...
                                Widget.prototype.launchView = function () {
                                    ...
                                    com.jtm.helper.DropDownList.fillLocal({
                                        ...
                                        callback: function (e) {
                                            if (jQuery(this).val() == Widget.CLASSBREAKSDEF)
                                ...
                                Widget.prototype.onMouseClickChartToGraphic = function (e, graphics, index) {
                                    var thiss = this;
                                    var g = null;
                                    var i = 0;
                                ...
                                Widget.prototype.onMouseOverChartToGraphic = function (e, graphics, index) {
                                    var thiss = this;
                                    var g = null;
                                ...
                                Widget.prototype.onMouseOutChartToGraphic = function (e, graphics) {
                                    var thiss = this;
                                ...
                                Widget.prototype.onMouseClickGraphicToChart = function (e) {
                                    var thiss = this;
                                ...
                                Widget.prototype.onMouseOverGraphicToChart = function (e, series, index) {
                                    var thiss = this;
                                ...
                                Widget.prototype.onMouseOutGraphicToChart = function (e, series) {
                                    var thiss = this;
                                ...
                                return Widget;
                            })(thematicmap.BaseWidget);
                            thematicmap.Widget = Widget;
