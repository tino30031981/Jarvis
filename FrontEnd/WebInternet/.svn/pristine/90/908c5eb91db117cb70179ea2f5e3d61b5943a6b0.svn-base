                            ...
                            var Widget = (function (_super) {
                                ...
                                function Widget() {
                                    ...
                                    this.query = function (layerId, where, outField, ddl) {
                                        var thiss = this;
                                        if (layerId == Widget.DDLVALUEDEFAULT2) {
                                        ...
                                        function fill(data, spatialReference) {
                                            ...
                                            jQuery(ddl2).html("");
                                            jQuery(ddl2).append('<option value="' + Widget.DDLVALUEDEFAULT + '">' + Widget.DDLDISPLAYDEFAULT + '</option>');
                                            var items = [];
                                            var i = 0;
                                    ...
                                    this.getDepartments = function (items) {
                                        ...
                                        function parse(data) {
                                            var i = 0;
                                            var items2 = [];
                                            items2.push({ id: Widget.DDLVALUEDEFAULT2, name: Widget.DDLDISPLAYDEFAULT, code: Widget.DDLVALUEDEFAULT2 });
                                            for (i = 0; i < data.length; i++) {
