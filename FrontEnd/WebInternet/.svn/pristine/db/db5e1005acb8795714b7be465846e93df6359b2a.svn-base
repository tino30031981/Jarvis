function getObject() {
    return com.jtm.geometry.viewer.widgets.custom.vip.variable.Widget.execute();
}
(function (com) {
    (function (jtm) {
        (function (geometry) {
                            ...
                            (function (variable) {
                                var Widget = (function (_super) {
                                    ...
                                    Widget.prototype.search = function (value) {
                                        ...
                                        var queryTask = new esri.tasks.QueryTask(thiss.config.module.widget.serviceData.url + "/" + thiss.config.module.widget.serviceData.layerId);
                                        var query = new esri.tasks.Query();
                                        query.where = thiss.getSql(value);
                                        query.outFields = ['*'];
                                        query.returnGeometry = true;
                                        queryTask.execute(query, function (data) {
                                            data.features.forEach(function (feature) {
