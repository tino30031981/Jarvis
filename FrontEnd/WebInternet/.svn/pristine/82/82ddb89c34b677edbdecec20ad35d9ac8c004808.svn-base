function getInstance() {
    return com.jtm.documentlibrary.BaseFolder.execute();
}
(function (com) {
    (function (jtm) {
        (function (documentlibrary) {
            var BaseFolder = (function (_super) {
                __extends(BaseFolder, _super);
                function BaseFolder() {
                    _super.call(this);
                    ...
                    this.listFolder = function () {
                        ...
                        thiss.searchConfig(thiss.urlListFolder, { data: {moduleId:0} }, function (items) {
                ...
                BaseFolder.ULRESULTFOLDERS = "#divResultFolder";
                BaseFolder.prototype.form = function (url, id, options) {
                    var thiss = this;
                ...
                BaseFolder.prototype.save = function (url, data, options, callback) {
                    var thiss = this;
                    var data = {
                ...
                BaseFolder.prototype.delete = function (id, url,  options, callback) {
                    var thiss = this;
                    options = options || {};
                    options.data = { id: id };
                ...
                BaseFolder.prototype.domConfig = function () {
                    var thiss = this;
                    thiss.$divResultFolder = this.$form.find(BaseFolder.ULRESULTFOLDERS);
                ...
                BaseFolder.prototype.buttonConfig = function () {
                    var thiss = this;
                ...
                BaseFolder.prototype.load = function ($container, options) {
                    var thiss = this;
                    options = options || {};
                    //thiss.$hdnId = options.$hdnId;
                    thiss.urlDelete = options.urlDelete;
                    thiss.urlForm = options.urlForm;
                    thiss.urlListFolder = options.urlListFolder;
                    thiss.urlSave = options.urlSave;
                    thiss.urlFormFolder = options.urlFormFolder;
                    if (String.isNullOrWhiteSpace($container) === true)
                        $container = this.$form;
                    if (typeof $container === "string")
                        $container = jQuery($container);
                    this.$form = ($container.length === 0) ? this.$form : $container;
                    this.$main = this.$form.parent().find(BaseFolder.DOMMAIN);
                    this.form();
                };
                BaseFolder.execute = function () {
                    return new BaseFolder();
                };
                return BaseFolder;
            })(jtm.Master);
            documentlibrary.BaseFolder = BaseFolder;
