                            ...
                            var BaseWidget = (function (_super) {
                                ...
                                function BaseWidget() {
                                    ...
                                    this.processLayer = function (id) {
                                        ...
                                        jQuery(table).html("");
                                        thiss.layer.clear();
                                        if (id == BaseWidget.DDLVALUEDEFAULT2) return;
                                        var outFields = [];
                                        getFields();
                                        addLayer();
                                        function getFields() {
                                        ...
                                        function addLayer() {
                                            var query = new esri.tasks.BaseWidget();
                                ...
                                BaseWidget.prototype.initConfig = function () {
                                    ...
                                    function parseLayers(service, layers) {
                                        var pattern = /\b(\w|\W)+\b/;
                                        service.indicators = [];
                                        service.indicators.push({ id: BaseWidget.DDLVALUEDEFAULT2, name: BaseWidget.DDLDISPLAYDEFAULT });
                                        var i = 0;
                                ...
                                BaseWidget.prototype.onMouseDoubleClickElementToGraphic = function (element, graphics, index) {
                                    var thiss = this;
