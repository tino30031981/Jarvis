function getObject() {
    return com.jtm.geometry.viewer.widgets.custom.forestrycadaster.Widget.execute();
}
(function (com) {
    (function (jtm) {
        (function (geometry) {
                            ...
                            var Widget = (function (_super) {
                                ...
                                function Widget() {
                                    ...
                                    this.getCql = function () {
                                        ...
                                        var agreementNumber = this.$widget.find('#txtAgreementNumber').string();
                                        var holderName = this.$widget.find('#txtHolderName').string();
                                        var cql = "strToLowerCase(codigo) LIKE '%{0}%' AND strToLowerCase(numerocontrato) LIKE '%{1}%' AND strToLowerCase(titular) LIKE '%{2}%'";
                                        return cql.replace("{0}", code.toLowerCase()).replace("{1}", agreementNumber.toLowerCase()).replace("{2}", holderName.toLowerCase());
                                    };
                                }
                                ...
                                return Widget;
                            })(forestrycadaster.BaseWidget);
                            forestrycadaster.Widget = Widget;
