function getObject() {
    return com.jtm.geometry.viewer.widgets.custom.surfacepropertynational.Widget.execute();
}
(function (com) {
    (function (jtm) {
        (function (geometry) {
                    ...
                    (function (custom) {
                        (function (surfacepropertynational) {
                            var Widget = (function (_super) {
                                ...
                                Widget.prototype.searchOnService = function (options) {
                                    ...
                                    task.execute(query).addCallback(function (response) {
                                        if (response.features == undefined || response.features.length == 0) {
                                            toastr.info('No se han encontrado datos');
                                            return;
                                        }
                                ...
                                return Widget;
                            })(surfacepropertynational.BaseWidget);
                            surfacepropertynational.Widget = Widget;
