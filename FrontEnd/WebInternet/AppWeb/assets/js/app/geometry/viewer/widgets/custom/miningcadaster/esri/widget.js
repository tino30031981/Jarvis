function getObject() {
    return com.jtm.geometry.viewer.widgets.custom.miningcadaster.Widget.execute();
}
(function (com) {
    (function (jtm) {
        (function (geometry) {
                    ...
                    (function (custom) {
                        (function (miningcadaster) {
                            var Widget = (function (_super) {
                                ...
                                Widget.prototype.searchOnService = function () {
                                    var thiss = this;
                                    ...
                                    task.execute(query).addCallback(function (response) {
                                        if (response.features.length === 0) {
                                            toastr.info('No existen resultados');
                                            return;
                                        }
                                ...
                                return Widget;
                            })(miningcadaster.BaseWidget);
                            miningcadaster.Widget = Widget;
