            ...
            (function (viewer) {
                (function (widgets) {
                    (function (overlappingarea) {
                        var BaseWidget = (function (_super) {
                            ...
                            function BaseWidget() {
                                ...
                                this.query = function (geometry) {
                                    ...
                                    var i = 0;
                                    var services = [];
                                    if (jQuery('#' + thiss.domWidget + ' #ddlLayer').val() == BaseWidget.DDLVALUEDEFAULT2)
                            ...
                            BaseWidget.prototype.launchView = function () {
                                ...
                                function fillServices() {
                                    var html = '';
                                    var i = 0;
                                    html += '<option value="' + BaseWidget.DDLVALUEDEFAULT2 + '">' + thiss.config.module.widget.descriptionLabel.allServices + '</option>';
                                    for (i = 0; i < thiss.config.module.widget.services.length; i++) {
                                ...
                                function setCoordinate() {
                                    ...
                                    function buildGeometry() {
                                        ...
                                        var radio = jQuery("#" + thiss.domWidget + " #txtRadio").val() * BaseWidget.KILOMETER;
                        ...
                        overlappingarea.BaseWidget = BaseWidget;
