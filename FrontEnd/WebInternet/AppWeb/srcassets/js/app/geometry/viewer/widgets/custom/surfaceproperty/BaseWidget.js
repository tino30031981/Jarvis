                        ...
                        (function (surfaceproperty) {
                            var BaseWidget = (function (_super) {
                                ...
                                function BaseWidget() {
                                    ...
                                    this.$txtProcurementDateStartSearch = null;
                                    this.$txtProcurementDateEndSearch = null;
                                    this.$btnSearch = null;
                                    this.$btnClean = null;
                                    ...
                                    this.cleanData = function () {
                                        ...
                                        if (thiss.$txtProcurementDateStartSearch !== null)
                                            thiss.$txtProcurementDateStartSearch.val('');
                                        if (thiss.$txtProcurementDateEndSearch !== null)
                                            thiss.$txtProcurementDateEndSearch.val('');
                                        if (thiss.$table !== null)
                                            thiss.$table.empty();
                                    };
                                ...
                                BaseWidget.prototype.launchView = function () {
                                    ...
                                    this.$txtProcurementDateStartSearch = thiss.$widget.find('#txtProcurementDateStartSearch');
                                    this.$txtProcurementDateEndSearch = thiss.$widget.find('#txtProcurementDateEndSearch');
                                    ...
                                    thiss.datePicker(thiss.$txtProcurementDateStartSearch);
                                    thiss.datePicker(thiss.$txtProcurementDateEndSearch);
                                    thiss.htmlServices = "";
                                ...
                                BaseWidget.prototype.search = function () {
                                    ...
                                    thiss.searchConfig(com.jtm.Server.contextPath + "surfaceproperty/surfaceright/search", options, function (items) {
                                        if (items.length === 0) {
                                ...
                                BaseWidget.prototype.parameters = function () {
                                    ...
                                    var item = {
                                        ...
                                        procurementDateStart: thiss.$txtProcurementDateStartSearch.val(),
                                        procurementDateEnd: thiss.$txtProcurementDateEndSearch.val(),
                                        address: { home: "" }
                                    };
                                    item.district = {
                                        id: "0",
                                    ...
                                    item.cadasterCode = "";
                                    item.holder = { id: 0 };
                                    item.usePresent = { id: 0 };
                                    item.miningUnit = { id: 0 };
                                    item.physicalSituation = { id: 0 };
                                    item.legalSituation = { id: 0 };
                                    item.condition = { id: 0 };
                                    item.group = { id: 0 };
                                    item.formerOwner = "";
                                    return item;
                            ...
                            surfaceproperty.BaseWidget = BaseWidget;
                        })(custom.surfaceproperty || (custom.surfaceproperty = {}));
                        var surfaceproperty = custom.surfaceproperty;
