                                ...
                                function BaseWidget() {
                                    ...
                                    this.query = function (where, outField, ddl) {
                                        ...
                                        function fill(data) {
                                            ...
                                            var html = '<option value="' + BaseWidget.DDLVALUEDEFAULT + '">' + BaseWidget.DDLDISPLAYDEFAULT + '</option>';
                                            var i = 0;
                                    ...
                                    this.getZeesByZone = function (nameDepartment, nameProvince, nameLargeZone, nameZone) {
                                        ...
                                        thiss.layer.clear();
                                        thiss.closeData(thiss.dialogData);
                                        if (nameDepartment == BaseWidget.DDLVALUEDEFAULT) return;
                                        if (nameProvince == BaseWidget.DDLVALUEDEFAULT) return;
                                        //if (nameDistrict == BaseWidget.DDLVALUEDEFAULT) return;
                                        if (nameLargeZone == BaseWidget.DDLVALUEDEFAULT) return;
                                        if (nameZone == BaseWidget.DDLVALUEDEFAULT) return;
