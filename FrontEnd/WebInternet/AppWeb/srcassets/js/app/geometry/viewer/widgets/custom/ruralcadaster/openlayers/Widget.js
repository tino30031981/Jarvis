function getObject() {
    return com.jtm.geometry.viewer.widgets.custom.ruralcadaster.Widget.execute();
}
(function (com) {
    (function (jtm) {
        (function (geometry) {
                            ...
                            var Widget = (function (_super) {
                                ...
                                function Widget() {
                                    ...
                                    this.getCql = function () {
                                        var code = this.$widget.find('#txtCode').string();
                                        var name = this.$widget.find('#txtName').string();
                                        var holderName = this.$widget.find('#txtHolderName').string();
                                        var cql = "strToLowerCase(codigo) LIKE '%{0}%' AND strToLowerCase(nombre) LIKE '%{1}%' AND strToLowerCase(nombretitular) LIKE '%{2}%'";
                                        return cql.replace("{0}", code.toLowerCase()).replace("{1}", name.toLowerCase()).replace("{2}", holderName.toLowerCase());
                                    };
                                }
                                ...
                                return Widget;
                            })(ruralcadaster.BaseWidget);
                            ruralcadaster.Widget = Widget;
                        })(custom.ruralcadaster || (custom.ruralcadaster = {}));
                        var ruralcadaster = custom.ruralcadaster;
