...
namespace AppWeb.Controllers
{
    ...
    {
        // GET: Base
        //protected const String DEFAULTUSER = "guest@guest.com";
        //protected const String DEFAULTPASSWORD = "guest@guest.com";
        protected const String DEFAULTUSER = "aplicaciones@jazani.pe";
        protected const String DEFAULTPASSWORD = "jazani.2018";
        //protected const String DEFAULTUSER = "propiedades@gmail.com";
        ...
        protected const String LOGIN = "admin/user/login";
